...
const buttonVariants = cva(
  "group/button inline-flex min-w-fit shrink-0 cursor-pointer items-center justify-center gap-2 rounded-sm border-2 border-transparent bg-clip-padding px-2 text-sm font-medium normal-case whitespace-nowrap transition-colors outline-none select-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:border-neutral-300 disabled:bg-neutral-100 disabled:text-neutral-600 disabled:opacity-100 dark:disabled:border-monitor-gray-300 dark:disabled:bg-monitor-gray-100/60 dark:disabled:text-neutral-400 aria-disabled:pointer-events-none aria-disabled:cursor-not-allowed aria-disabled:border-neutral-300 aria-disabled:bg-neutral-100 aria-disabled:text-neutral-600 aria-disabled:opacity-100 dark:aria-disabled:border-monitor-gray-300 dark:aria-disabled:bg-monitor-gray-100/60 dark:aria-disabled:text-neutral-400 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-monitor focus-visible:ring-offset-2 focus-visible:ring-offset-background dark:focus-visible:ring-warning dark:focus-visible:ring-offset-base",
  {
    variants: {
      variant: {
        default:
